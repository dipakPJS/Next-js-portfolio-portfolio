...
const HeroContent = () => {
  ...
  initial="hidden"
  animate="visible"
  className="flex flex-row items-center justify-center px-5 md:px-20 mt-10 md:mt-40 w-full z-[20]"
>
  <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
    <motion.div
      variants={slideInFromTop}
      className="Welcome-box py-2 md:py-8 px-2 md:px-7 border border-orange-500 opacity-[0.9]"
    >
      <SparklesIcon className="text-[#b49bff] mr-2 md:mr-10 h-4 md:h-5 w-4 md:w-5" />
      <h1 className="Welcome-text text-xs md:text-lg">
